...
export const APPS = [
  {
    ...
    topics: ['your_turn', 'invite', 'nudge', 'opponent_joined', 'solo_turn', 'game_finished', 'invite_declined'],
  },
  {
    key: 'rungles',
    label: 'Rungles',
    icon: 'R',
    gradient: 'from-wordy-600 to-wordy-800',
    topics: ['your_turn', 'invite', 'nudge', 'opponent_joined', 'game_finished', 'invite_declined'],
  },
  {
    key: 'snibble',
    label: 'Snibble',
