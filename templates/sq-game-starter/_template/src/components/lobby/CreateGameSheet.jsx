...
// {{name}} MP CreateGameSheet — GENERIC N-player game creator (ported
// from Yahdle / Wordy). Works as-is for any SQ game.
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-display text-lg">New {{name}} game</h2>
