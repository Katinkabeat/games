...
import { SQErrorBoundary, installGlobalErrorReporting, installPushHeal, installNotificationNav } from '../../rae-side-quest/packages/sq-ui'
import './index.css'
...
// hub-scoped iframe, so nothing here depends on a game service worker. Push is
// SENT by the {{slug}}-push-notification edge function to the hub subscription.

ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <SQErrorBoundary label="{{slug}}">
      <ThemeProvider>
